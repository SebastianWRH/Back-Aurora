...
const products = [
  {
    category: 'collares',
    name: 'Collar de perlas checas',
    slug: 'collar-de-perlas',
    description: 'Collar de perlas checas con acabado elegante y broche dorado, pensado para ocasiones especiales y looks delicados.',
    price: 60,
